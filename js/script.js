...
let user_icon = document.querySelector('.actions_user ');

user_icon.addEventListener('click', function (e) {
	let user_menu = document.querySelector('.actions_menu');
	user_menu.classList.toggle('active');

});


let iconMenu = document.querySelector(".menu_burger");
let body = document.querySelector("body");
let menuBody = document.querySelector(".header_menu_items");
if (iconMenu) {
...
document.addEventListener('click', function (e) {
	if (!e.target.closest('.actions_user')) {
		let user_menu = document.querySelector('.actions_menu');
...
var main_slider = new Swiper('.main-slider_body', {
	/*
	effect: 'fade',
	autoplay: {
		  delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.control-main-slider_arrow__next',
		prevEl: '.control-main-slider_arrow__prev'
	},
	breakpoints: {
		320: {
			autoHeight: true
...
var lots_slider = new Swiper('.slider-lots_body', {
	/*
	effect: 'fade',
	autoplay: {
		  delay: 3000,
  ...
  */
	...
	// Arrows
	navigation: {
		nextEl: '.control-slider-lots_arrow__next',
		prevEl: '.control-slider-lots_arrow__prev'
	},
	breakpoints: {
		320: {
			slidesPerView: 1
...
var quotes_slider = new Swiper('.slider-quotes_body', {
  effect: 'fade',
  ...
  // Arrows
  navigation: {
    nextEl: '.control-slider-quotes_circle'
  },
  breakpoints: {
    320: {
      autoHeight: true
...
if (link) {
	...
	var _loop7 = function _loop7(_index28) {
      ...
      if (document.querySelector('.header_menu_items._active')) {
				menu_close();
